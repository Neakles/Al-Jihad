    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="portl">
                    <div class="portl-title">
                        <div class="caption">
                            <div class="caption-subject font-red sbold uppercase">Data Diri Santri</div>
            ...
            <form action="/pendataan/save" method="post">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12 ">
                    ...
                    <div class="portl">
                        <div class="portl-body">
                            <div class="form-body">
                                <div class="form-group">
                                    <select class="form-control" name="thn_masuk" id="thn-masuk" required>
                                        <option value="">Tahun Masuk</option>
                                        <?php for ($i = date("Y"); $i >= 1995; $i--) { ?>
                                            <option value="<?php echo $i ?>"><?php echo $i ?></option>
                                        <?php } ?>
                                    </select>
                                    <label for="form_control_1">Tahun Masuk</label>
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control" name="nama_santri" id="nama_santri" id="form_control_1" placeholder="Masukkan Nama Anda" required>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" id="form_control_1" placeholder="Masukkan Tempat Lahir" required>
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="tgl" id="tgl" style="width:10vh;float:left;margin-right:15px" required>
                                        <option value="">Tanggal</option>
                                        <?php for ($i = 1; $i <= 31; $i++) { ?>
                                            <option value="<?php echo $i ?>"><?php echo $i ?></option>
                                        <?php } ?>
                                    </select>
                                    <select class="form-control" name="bln" id="bln" style="width:10vh;float:left;margin-right:15px" required>
                                        <option value="">Bulan</option>
                                        <?php for ($i = 1; $i <= 12; $i++) { ?>
                                            <option value="<?php echo $i ?>"><?php echo $i ?></option>
                                        <?php } ?>
                                    </select>
                                    <select class="form-control" name="thn" id="thn" style="width:10vh;" required>
                                        <option value="">Tahun</option>
                                        <?php for ($i = date("Y"); $i >= 1925; $i--) { ?>
                                            <option value="<?php echo $i ?>"><?php echo $i ?></option>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control" name="no_hp" id="no_hp" id="form_control_1" placeholder="Masukkan Nomor Handphone	">
                                ...
                                <div class="form-group col-xs-12 col-sm-12 col-lg-4">
                                    <input type="number" class="form-control" name="anak_ke" id="anak_ke" id="form_control_1" placeholder="Anak Ke" required>
                                ...
                                <div class=" form-group col-xs-12 col-sm-12 col-lg-4">
                                    <input type="number" class="form-control" name="dari_s" id="dari_s" id="form_control_1" placeholder="Dari" required>
                    ...
                    <div class="portl ">
                        <div class="portl-body">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="alamat" id="alamat" id="form_control_1" placeholder="Masukkan Alamat Rumah (Sesuai KTP)">
                                    <label for="form_control_1">Alamat Rumah (Sesuai KTP)
                                    </label>
                                    <span class="help-block">Tolong Masukkan Alamat Rumah Anda (Sesuai KTP)...</span>
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control" name="prov" id="prov" id="form_control_1" placeholder="Masukkan Provinsi" required>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="kab" id="kab" id="form_control_1" placeholder="Masukkan Kabupaten/Kota" required>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="kec" id="kec" id="form_control_1" placeholder="Masukkan Kecamatan" required>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="dusun" id="dusun" id="form_control_1" placeholder="Masukkan Dusun" required>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="desa" id="desa" id="form_control_1" placeholder="Masukkan Desa" required>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="pos" id="pos" id="form_control_1" placeholder="Masukkan Kode POS" required>
                ...
                <!-- BEGIN FORM  -->
                <div class="portl col-md-6 col-sm-12 col-xs-12 ">
                    <!-- BEGIN VALIDATION STATES-->
                    <div class="portl">
                        <div class="portl-body">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="form_control_1">Jenis Pendidikan </label>
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control" name="nama_sekolah" id="nama_sekolah" id="form_control_1" placeholder="Masukkan Nama Sekolah">
                                    <label for="form_control_1">Nama Sekolah
                                    </label>
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control" name="alamat_sekolah" id="alamat_sekolah" id="form_control_1" placeholder="Masukkan Alamat Sekolah">
                                    <label for="form_control_1">Alamat Sekolah
                                    </label>
                                </div>
                                <div class="form-group">
                                    ...
                                    <label for="form_control_1">Pesantren Asal
                                    </label>
                                </div>
                                <div class="form-group col-xs-12 col-sm-12 col-lg-4">
                                ...
                                <div class="form-group col-xs-12 col-sm-12 col-lg-4">
                                    <select class="form-control" name="thn_lulus_sek" id="thn_lulus_sek" style="width:15vh;">
                                        <option value="">Tahun</option>
                                        <?php for ($i = date("Y"); $i >= 1925; $i--) { ?>
                                            <option value="<?php echo $i ?>"><?php echo $i ?></option>
                                        <?php } ?>
                                    </select>
                                    <label for="form_control_1">Tahun Lulus</label>
                    ...
                    <div class="portl ">
                        <div class="portl-body">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="pt" id="pt" id="form_control_1" placeholder="Masukkan Perguruan Tinggi (PT)">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="fakultas" id="fakultas" id="form_control_1" placeholder="Masukkan Fakultas">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="jur" id="jur" id="form_control_1" placeholder="Masukkan Jurusan">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12 ">
                    ...
                    <div class="portl">
                        <div class="portl-body">
                            <div class="form-body">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="nama_ayah" id="nama_ayah" id="form_control_1" placeholder="Masukkan Nama Ayah Anda" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="form_control_1">NIK/Nomor KTP
                                    </label>
                                </div>
                        ...
                        <div class="portl-body">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <label for="form_control_1">Nomor Kartu Keluarga
                                        <span class="required">*</span>
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="form_control_1">Status Kepala Keluarga dalam KK </label>
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control" name="hp_wali" id="hp_wali" id="form_control_1" placeholder="Nomor Handphone">
                                    <label for="form_control_1">Nomor Handphone</span>
                                        <span class="required">*</span>
                                    </label>
                                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="portl">
                        <div class="portl-title">
                            <div class="caption">
                                <div class="caption-subject font-red sbold uppercase">Data Wali Santri</div>
                        ...
                        <div class="portl-body">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <label for="form_control_1">Nama Wali
                                    </label>
                ...
                <div class="portl col-md-12 col-sm-12 col-xs-12">
                    <div class="portl-body">
                        <div class="form-body">
